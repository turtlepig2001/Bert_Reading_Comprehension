...
Details:对底层代码做了微小改动，其中的英文注释未作翻译，底层代码链接：https://paddlenlp.readthedocs.io/zh/latest/_modules/paddlenlp/metrics/squad.html#compute_prediction
'''
import collections
import re
import string
...
def compute_prediction(
    ...
    Args:
        examples (list): List of raw squad-style data
        features (list): List of processed squad-style features
